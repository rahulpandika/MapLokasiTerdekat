...
public class MainActivity extends AppCompatActivity implements LocationListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ArrayAdapter<String> myAdapter = new ArrayAdapter<>(MainActivity.this, android.R.layout.simple_list_item_1, getResources().getStringArray(R.array.cari_tempat));
    ...
    private class ParserTask extends AsyncTask<String, Integer, List<HashMap<String, String>>> {
        ...
        protected List<HashMap<String, String>> doInBackground(String... jsonData) {
            ...
            ParsePlace parserPlace = new ParsePlace();
            try {
        ...
        //method untu menampilkan semua tempat dalam list dan menambahbah tanda(marker) serta menmindahkan kamera/sorot
        @Override
